...
*/
const phrase = 'Grandes poderes trazem grandes responsabilidades.';
// console.log(phrase);
...
const m = mozilla.slice(0, 1);
const d = mozilla.slice(8, 9);
const n = mozilla.slice(18, 19);
const mdn = m + d + n;
// console.log(mdn.toLocaleLowerCase());
...
const bookMessage =
  "'O Conto da Aia  ' é um dos livros mais vendidos da década.";
