...
let addFood = brazilianFoods.push('Coxinha', null, 'Brigadeiro');
...
const foodsInfo = `Até aqui o, BraziliaFoods possui, ${brazilianFoods.length} itens: ${brazilianFoods[0]}, ${brazilianFoods[1]} e ${brazilianFoods[2]}`;
...
let dogNames = maleDogNames.concat(femaleDogNames.concat());
...
// const allDogNames = dogNames.join(', ');
const allDogNames = dogNames.pop();
