...
const my3FavoriteTVShows = ['Game of Thrones', 'Breaking Bad', 'Dark'];
...
const charNumbers = `A string que a "typeSentence" armazena tem mais de ${number}  
caracteres? ${String(typeSentence.length > number).replace('t', 'T')}`; //.replace('true', 'True');
...
// Porque nao é um resultado Falsy
...
const total = `A soma entre o 1º e o 3º item de "ages" é menor ou igual a 92. Essa afirmação é: ${
  agesSum <= 92
}.`;
// console.log(total);
