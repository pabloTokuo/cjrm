...
h2.addEventListener("copy", copyH2Text);
egg.addEventListener("mousemove", eggOffSet);
...
const isSomePersonFrontEndDeveloper = peoples.some(({ profession }) => profession === "Front-end developer");
