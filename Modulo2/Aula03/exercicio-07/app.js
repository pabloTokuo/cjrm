...
for (let i = 0; i < randomNumbers.length; i++) {
  ...
  if (totalSum > 400) {
    // console.log(
    //   `A soma ultrapassou 400. Até aqui, o valor atual é ${totalSum}`,
    // );
    break;
  }
}
...
const lastItem = firstStrings[firstStrings.length - 1];

console.log(`As primeiras 3 strings são ${firstStrings.join(', ').replace(`, ${lastItem}`, ` e ${lastItem}`)}
