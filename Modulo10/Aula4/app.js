...
const calculator = (operator) => (num1, num2) => {
  ...
  return operation[operator] || "Operação inválida";
};
...
const sul = ["Rio Grande do Sul", "Parana", "Santa Catarina"];
const sudeste = ["São Paulo", "Minas Gerais", "Rio de Janeiro"];
const nordeste = ["Amazonas", "Bahia", "Salvador"];

const brasil = sul.concat(sudeste);
brasil.unshift("Amazonas", "Bahia", "Salvador");
