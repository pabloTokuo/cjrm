...
const getOddNumbers = oddNumber => oddNumber % 2 != 0;
...
const productsList = cart.reduce((acc, { name }) => `${acc}- ${name}\n`, '')
...
const tvNameShows = tvShows.map(({ name }) => name);

console.log(tvNameShows);
