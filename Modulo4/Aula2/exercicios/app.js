...
// console.log(age);
//Porque estamos tentando acessar a variavel fora do escopo de codigo dela.
myAge();
...
const car = {
  ...
  getColorsMessage () {
    console.log(`O ${this.name} está disponível nas cores ${this.colors.join(", ").replace(this.colors[this.colors.length - 1], `e ${this.colors[this.colors.length - 1]}`)}`);
  }
}
